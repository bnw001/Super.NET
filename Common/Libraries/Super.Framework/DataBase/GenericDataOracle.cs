...
namespace Super.Framework
{
    ...
    /// Oracle泛型数据类
    /// </summary>
    public class GenericDataOracle<T> : IGenericData<T> where T : new()
    {
        #region 查询
        ...
        {
            DataTable reVal = new DataTable();
            string _ConnStrng = _IConnString.IsNullOrEmpty() ? Config.OracleReadDBConnectionString : _IConnString;
            ...
            OracleHelper DbHelper = new OracleHelper(_ConnStrng);
