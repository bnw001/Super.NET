...
namespace Super.Framework
{
    ...
    public class MySqlHelper : IDBHelper
    {
        ...
        /// 参数缓存
        /// </summary>
        private static Dictionary<string, MySqlParameter[]> _CacheProcSqlParameter = new Dictionary<string, MySqlParameter[]>();
        ...
        public MySqlHelper()
        {
            this.ConnectionString = Config.MySqlConnectionString;
        ...
        public MySqlHelper(int commandTimeOut)
        {
            if (commandTimeOut >= 0)
            {
        ...
        public MySqlHelper(string connString, int commandTimeOut)
        {
            this.ConnectionString = connString;
            if (commandTimeOut > 0)
            {
        ...
        {
            DbParameter[] cmdParms = new DbParameter[] { };
            return RunProcedureDataSet(_IStoredProcName, cmdParms);
        }
        ...
        /// <param name="cmdParms">参数列表</param>
        private void PrepareCommand(MySqlCommand cmd, MySqlConnection conn, MySqlTransaction trans, CommandType cmdType, string cmdText, DbParameter[] cmdParms)
        {
        ...
        /// <param name="cmdText">Command text，T-SQL语句</param>
        /// <param name="cmdParms">参数列表</param>
        private void PrepareCommand(MySqlCommand cmd, MySqlConnection conn, MySqlTransaction trans, CommandType cmdType, string cmdText, Dictionary<string, string> cmdParms)
        {
            if (conn.State != ConnectionState.Open)
            {
                conn.Open();
            ...
            if (cmdParms != null)
            {
                ...
                {
                    SqlParm = new MySqlParameter(parm.Key, parm.Value);
