...
namespace Super.Framework
{
    ...
    /// Sqlite泛型数据类
    /// </summary>
    public class GenericDataSqlite<T> : IGenericData<T> where T : new()
    {
        #region 查询
        ...
        {
            DataTable reVal = new DataTable();
            string _ConnStrng = _IConnString.IsNullOrEmpty() ? Config.SQLiteReadConnectionString : _IConnString;
            ...
            SQLiteHelper DbHelper = new SQLiteHelper(_ConnStrng);
