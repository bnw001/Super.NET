...
namespace AliPay.Pay.Strategy
{
    ...
    public class Core
    {
        ...
        #endregion 除去数组中的空值和签名参数并以字母a到z的顺序排序
        ...
        #endregion 把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串

        #region 把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串，并对参数值做urlencode
        /// <summary>
        ...
        #endregion 把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串，并对参数值做urlencode

        #region 写日志
        /// <summary>
        /// 写日志
        /// </summary>
        /// <param name="sWord">日志的详细信息</param>
        /// <param name="Level">日志级别</param>
        public static void LogResult(string sWord, string Level = "Info")
        {
            if (Level == "Info")
            {
                Log.Info("AliPay " + sWord);
            }
            else if (Level == "Warning")
            {
                Log.Warning("AliPay " + sWord);
            }
            else
            {
                Log.Error("AliPay " + sWord);
            }
        }
        #endregion 写日志
